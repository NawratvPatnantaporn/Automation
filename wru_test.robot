...
TC-T101 Register without any fields account 
    ...
    Sleep   2
    Capture Page Screenshot
TC-T102 Register with already exists email 
    Open Browser    http://localhost:5173/  Chrome  
    Maximize Browser Window
...
TC-T103 Register with already exists idcard 
    Open Browser    http://localhost:5173/  Chrome  
    Maximize Browser Window
...
TC-T104 Register with already exists phonenumber 
    Open Browser    http://localhost:5173/  Chrome  
    Maximize Browser Window
